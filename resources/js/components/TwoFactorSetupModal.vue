...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            title: 'Kétlépcsős hitelesítés bekapcsolva',
            description:
                'Olvasd be a QR-kódot, vagy add meg a beállítókulcsot a hitelesítő alkalmazásban.',
            buttonText: 'Bezárás',
        };
    }
    ...
    if (showVerificationStep.value) {
        return {
            title: 'Hitelesítő kód ellenőrzése',
            description: 'Add meg a hitelesítő alkalmazás 6 jegyű kódját',
            buttonText: 'Folytatás',
        };
    }

    return {
        title: 'Kétlépcsős hitelesítés bekapcsolása',
        description:
            'Olvasd be a QR-kódot, vagy add meg a beállítókulcsot a hitelesítő alkalmazásban',
        buttonText: 'Folytatás',
    };
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >vagy add meg kézzel a kulcsot</span
                            >
                        </div>
