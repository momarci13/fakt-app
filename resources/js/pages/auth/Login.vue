    ...
    >
        <div class="grid gap-6">
            ...
            <Label for="remember" class="flex items-center space-x-3"
                ><Checkbox id="remember" name="remember" :tabindex="3" /><span
                    >Maradjak belépve</span
                ></Label
            >
            <Button
                type="submit"
                ...
                ><Spinner v-if="processing" />Belépés</Button
            >
        </div>
